                        ...
                        <div key={item._id} className="bg-gray-200 flex p-2">
                            ...
                            <div className="w-3/12  ">
                                <div className="flex justify-end items-center space-x-1">
                                    <div className="pe-3">
                                        <Tag name={item.tag.name} color={item.tag.color}></Tag>
                                    </div>
                                    <img src="./comment-3-svgrepo-com.svg" alt="Comments" className="w-7 h-5" />
                                    <div>520</div>
                                    <img src="./three-dots-vertical-svgrepo-com.svg" alt="Options" onClick={() => console.log("Clicked options")} className="w-7 h-5" />
                                </div>
                            </div>
                        </div>
                    </Link>
